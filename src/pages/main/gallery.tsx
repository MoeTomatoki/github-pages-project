...
export default function Gallery({
  ...
  const { carouselIndex, setCarouselIndex, dragX, onDragStart, onDragEnd } =
  ...
  return (
    <>
      <motion.div
        ...
        className={clsx(
          className,
          "flex mt-10 md:mt-2 items-center cursor-grab active:cursor-grabbing",
        )}
      >
        <ViewCarousel
          carouselIndex={carouselIndex}
          fromFetchQuery={fromFetchQuery}
        />
      </motion.div>
      <PaginationDots
        carouselIndex={carouselIndex}
      ...
      <div className="flex md:hidden flex-col items-center mt-4">
        {isLoading || status !== "success" ? (
          ...
          <div className="text-lg mt-8 text-justify text-neutral-600 dark:text-neutral-400">
